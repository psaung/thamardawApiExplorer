...
```
  ...
  since we do not have USER ID where (buyerUserId === 'SUDO DATA') || (sellerUserId === 'SUDO DATA')

  GET MY DRUG IN SALE AND GET MY ORDERS do not work on loopback npw

  You can check context of remote methods at
  ...
  I Have Disabled Lots Of Generated APIS

  Please DO NOT DISABLE any more remote methods generated by Loop Back

  Because Some Are Used In Data Entry Panel
